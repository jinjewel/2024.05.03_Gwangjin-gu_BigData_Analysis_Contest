...
# 엑셀 파일 경로
excel_file_path = "C:/Users/User/Desktop/2024_05_2024년광진구빅데이터분석공모전_본선/예선 준비/code/광진구내_지하철역별_24.5_예측_편차.xlsx"
...
max_abs_diff = subway_stations['user_number'].abs().max()
scale_factor = 50 / max_abs_diff

# 필터링된 버스 정류장을 지도에 표시
for index, row in subway_stations.iterrows():

    color = 'red' if row['user_number'] > 0 else 'blue'
    radius = abs(row['user_number']) * scale_factor
...
# HTML 파일로 저장
m.save('C:/Users/User/Desktop/2024_05_2024년광진구빅데이터분석공모전_본선/예선 준비/code/광진구내_지하철역별_24.5_예측_편차.html')
