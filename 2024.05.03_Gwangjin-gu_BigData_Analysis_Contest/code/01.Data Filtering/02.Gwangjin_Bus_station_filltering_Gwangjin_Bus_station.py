### 실제 광진구 버스정류장 데이터를 실제 지도와 비교하며 실제 광진구 내에 있는지 확인
...
# 엑셀 파일 경로
excel_file_path = "C:/Users/User/Desktop/2024_05_2024년광진구빅데이터분석공모전_본선/예선 준비/code/광진구_내_버스정류장_데이터.xlsx"

# 엑셀 파일 불러오기
df = pd.read_excel(excel_file_path)

# DataFrame에서 필요한 컬럼 선택
bus_stations = df[['ID', 'Latitude', 'longitude']]
...
# 엑셀 파일로 저장
filtered_stations.to_excel("C:/Users/User/Desktop/2024_05_2024년광진구빅데이터분석공모전_본선/예선 준비/code/광진구_내_버스정류장에서__필터링한_광진구_내_버스정류장_데이터.xlsx" , index=False)
...
# HTML 파일로 저장
m.save('C:/Users/User/Desktop/2024_05_2024년광진구빅데이터분석공모전_본선/예선 준비/code/광진구_내_버스정류장에서__필터링한_광진구_내_버스정류장.html')
